# Elk-Stack-Project
My first cloud network deployed on Azure
...
![Image of the Kibana interface](https://github.com/wevertonribeiroferreira/Azure-Virtual-Lab/blob/main/Images/filebeat.PNG)
